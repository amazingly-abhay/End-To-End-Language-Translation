...
class Decoder(torch.nn.Module):
    ...
    def forward(self,Y_padded_input_mini_batch,final_encoder_output,final_cell_state):
        ...
        decoder_lstm_layer_out,(final_decoder_lstm_layer_out,final_cell_state)=self.second_lstm_layer (first_embedding_layer_out,(final_encoder_output,final_cell_state))
